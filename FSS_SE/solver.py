        ...
        for epoch in range(self.start_epoch, self.num_epochs + 1):
            ...
            for phase in ['train', 'val']:
                ...
                for i_batch, sampled_batch in enumerate(data_loader[phase]):
                    s_x = sampled_batch['s_x'] # [B, Support, slice_num=1, 1, 224, 224]
                    X = s_x.squeeze(2)  # [B, Support, 1, 224, 224]
                    s_y = sampled_batch['s_y'] # [B, Support, slice_num, 1, 224, 224]
                    Y = s_y.squeeze(2)  # [B, Support, 1, 224, 224]
                    Y = Y.squeeze(2)  # [B, Support, 224, 224]
                    q_x = sampled_batch['q_x'] # [B, slice_num, 1, 224, 224]
                    q_x = q_x.squeeze(1)  # [B, 1, 224, 224]
                    q_y = sampled_batch['q_y'] # [B, slice_num, 1, 224, 224]
                    q_y = q_y.squeeze(1)  # [B, 1, 224, 224]
                    q_y = q_y.squeeze(1)  # [B, 224, 224]
