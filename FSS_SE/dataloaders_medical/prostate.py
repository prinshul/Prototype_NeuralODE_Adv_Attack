...
def metadata():
    info = {
    "src_dir" : "./CT_ORG/Training_2d_nocrop",
    "trg_dir" : "./CT_ORG/Training_2d_nocrop", # 144 setting
...
def external_testset(_config, target_task):
    def decathlon_spliter(idx):
        def path_collect(idx, option='train'):
            ...
            src_path = './Datasets/Decathlon_2d'
    ...
    def CT_ORG_spliter(idx):
        def path_collect(idx, option='train'):
            ...
            src_path = "./Datasets/CT_ORG/Training_2d_align"
