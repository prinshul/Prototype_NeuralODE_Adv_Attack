...
def metadata():
    info = {
    "src_dir" : "./CL_FSS/RawData/Training",
    # "src_dir" : "./CL_FSS/RawData/Training_denoise",
    "trg_dir" : "./CL_FSS/RawData/Training_2d",
    "trg_dir2" : "./CL_FSS/RawData/Training_2d_2",
    "trg_dir3" : "./CL_FSS/RawData/Training_2d_denoise",
    "trg_dir4" : "./CL_FSS/RawData/Training_2d_nocrop",
    }
    return info
