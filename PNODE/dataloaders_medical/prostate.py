...
def metadata():
    info = {
    "src_dir" : "./organ_data/BCV/Training_2d_nocrop",
    "trg_dir" : "./Abdomen/RawData/Training_2d", # 144 setting
    "trg_dir2" : "./Abdomen/RawData/Training_2d_2", # 144 setting
    "trg_dir3" : "./Abdomen/RawData/Training_2d_denoise",
...
def meta_data(_config):
    def path_collect(idx, option='train'):
        ...
        # print(f"{_config['data_src']}/{idx}/{option}/img/")
        # print(len(img_paths))
        label_paths = glob(f"{_config['data_src']}/{idx}/{option}/label/*")
        # img_paths = [f"{_config['data_src']}/img/"]
        # label_paths = [f"{_config['data_src']}/label/"]
...
def external_testset(_config, target_task):
    def decathlon_spliter(idx):
        def path_collect(idx, option='train'):
            ...
            src_path = '../../../organ_data/Decathlon/Training_2d_nocrop'
    ...
    def CT_ORG_spliter(idx):
        def path_collect(idx, option='train'):
            ...
            src_path = "../../../organ_data/CT_ORG/Training_2d_nocrop"
